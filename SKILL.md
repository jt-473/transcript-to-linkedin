...
2. From today's answers (all three, not just the voice question — real patterns show up everywhere someone talks), note: sentence length and rhythm, hedging vs. bluntness, recurring words or verbal tics, punctuation habits, how they open thoughts, how blunt or soft they are when disagreeing with something.
